...
<input name="idsalidas" type="text" placeholder="idsalidas" id="Texto1" />

<input name="fecha" type="date" placeholder="fecha" id="Texto2" />

<input name="cantidad" type="text" placeholder="cantidad" id="Texto3" />

<input name="idTRABAJADOR" type="text" placeholder="idTRABAJADOR" id="Texto4" />

<input name="CAMB" type="text" placeholder="CAMB" id="Texto5" />
