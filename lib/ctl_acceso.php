...
where estado = 1 and idtrabajador = '".htmlentities($_POST["usuario"])."'and contrasena = '".(htmlentities($_POST["contrasena"]))."'";
$myclave = mysqli_query($link,$sql);
$nmyclave = mysqli_num_rows($myclave);
//$nnmyclave = mysqli_num_rows(mysqli_query($link,$sql));
